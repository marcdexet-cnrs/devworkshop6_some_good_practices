...
[.fragment]
--
* And sometimes you still haven't defined exactly _what you really want_.
--
...
You think about *HOW* to get, in a _little_ less abstract way
...
Each _instruction_ is, itself, a goal to reach

image::images/marc/good_practices-what_how_call_hierarchie_3.svg[]

\... a *WHAT* at a _less_ abstract level.
...
\...Until you find _solution_ into the provided development ecosystem.
...
include::03_think_components.adoc[tag=include]
