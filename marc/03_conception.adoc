...
* Read good books
** https://en.wikipedia.org/wiki/The_Pragmatic_Programmer[Pragmatic Programer]
** https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882[Clean Code]
* Euclid Good Practices
** https://euclid.roe.ac.uk/projects/optim/wiki/Good_practices[]
